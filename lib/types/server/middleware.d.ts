...
export declare const defaultCacheSettings: CacheSettings;
export declare function fromDefaultCacheSettings(settings: CacheSettings): CacheSettings;
export declare type iExitHandler = undefined | (() => Promise<void>) | (() => void);
export declare type iHandlerType = (req: HTTPuppyRequest, res: HTTPuppyResponse) => Promise<void> | ((req: HTTPuppyRequest, res: HTTPuppyResponse) => void);
export declare type UserMiddlewareOption = {
    href: string;
