[httpuppy - v0.2.1](../README.md) / [Modules](../modules.md) / [types/server](../modules/types_server.md) / HTTPuppyResponse
...
[src/types/server/index.ts:103](https://github.com/abschill/httpuppy/blob/835be98/src/types/server/index.ts#L103)
...
[src/types/server/index.ts:102](https://github.com/abschill/httpuppy/blob/835be98/src/types/server/index.ts#L102)
