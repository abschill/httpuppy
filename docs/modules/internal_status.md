[httpuppy - v0.1.0](../README.md) / [Modules](../modules.md) / internal/status
...
[src/internal/status.ts:12](https://github.com/abschill/httpuppy/blob/f8e9db0/src/internal/status.ts#L12)
