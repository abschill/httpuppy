[httpuppy - v0.3.18](../README.md) / [Modules](../modules.md) / useRouter
...
[src/router.ts:15](https://github.com/abschill/httpuppy/blob/bdff4fd/src/router.ts#L15)
...
[src/router.ts:46](https://github.com/abschill/httpuppy/blob/bdff4fd/src/router.ts#L46)
...
[src/router.ts:128](https://github.com/abschill/httpuppy/blob/bdff4fd/src/router.ts#L128)
