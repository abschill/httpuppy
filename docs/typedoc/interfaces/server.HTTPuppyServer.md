[httpuppy - v0.3.7](../README.md) / [Modules](../modules.md) / [server](../modules/server.md) / HTTPuppyServer
...
[src/server.ts:44](https://github.com/abschill/httpuppy/blob/96efb1a/src/server.ts#L44)
...
[src/server.ts:40](https://github.com/abschill/httpuppy/blob/96efb1a/src/server.ts#L40)
...
[src/server.ts:41](https://github.com/abschill/httpuppy/blob/96efb1a/src/server.ts#L41)
...
[src/server.ts:39](https://github.com/abschill/httpuppy/blob/96efb1a/src/server.ts#L39)
...
▸ **ref**(): [`HTTPuppyServer`](server.HTTPuppyServer.md)
...
▸ **removeListener**(`eventName`, `listener`): [`HTTPuppyServer`](server.HTTPuppyServer.md)
...
[src/server.ts:42](https://github.com/abschill/httpuppy/blob/96efb1a/src/server.ts#L42)
...
[src/server.ts:43](https://github.com/abschill/httpuppy/blob/96efb1a/src/server.ts#L43)
