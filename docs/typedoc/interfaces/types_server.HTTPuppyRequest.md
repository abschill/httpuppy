[httpuppy - v0.2.16](../README.md) / [Modules](../modules.md) / [types/server](../modules/types_server.md) / HTTPuppyRequest
...
[src/types/server/index.ts:92](https://github.com/abschill/httpuppy/blob/cbe6067/src/types/server/index.ts#L92)
