[httpuppy - v0.2.20](../README.md) / [Modules](../modules.md) / [types/server](../modules/types_server.md) / HTTPuppyRequest
...
[src/types/server/index.ts:92](https://github.com/abschill/httpuppy/blob/9944926/src/types/server/index.ts#L92)
