[httpuppy - v0.2.17](../README.md) / [Modules](../modules.md) / [types/server](../modules/types_server.md) / HTTPuppyRequest
...
[src/types/server/index.ts:92](https://github.com/abschill/httpuppy/blob/2b1d5af/src/types/server/index.ts#L92)
